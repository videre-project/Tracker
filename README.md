<!-- # ![Videre Tracker](/assets/icon_36h.png) Videre Tracker -->

# Videre Tracker

![.NET](https://img.shields.io/badge/dynamic/yaml?label=.NET&labelColor=3f4551&color=8a2be2&prefix=v&query=$.sdk.version&url=https://raw.githubusercontent.com/videre-project/tracker/main/global.json)
...
![MTGOSDK Version](https://img.shields.io/badge/dynamic/json.svg?url=https://raw.githubusercontent.com/videre-project/Tracker/refs/heads/main/src/server/packages.lock.json&query=$.dependencies.*.MTGOSDK.resolved&label=MTGOSDK&logo=nuget&labelColor=3f4551)
![Version](https://img.shields.io/github/package-json/version/videre-project/tracker?label=Version&labelColor=3f4551)
...
Built on top of the [MTGOSDK](https://github.com/videre-project/MTGOSDK) library, the Tracker provides a modern web-based UI embedded in a native Windows application, giving you a seamless experience while tracking your matches and analyzing your performance.
...
- [ARCHITECTURE.md](/ARCHITECTURE.md) — A technical overview describing the project's architecture, data flow, and extensibility.

Additional guides and documentation will be added over time as the project evolves. For now, we recommend referring to the architecture doc and the [MTGOSDK documentation](https://github.com/videre-project/MTGOSDK#documentation) for furtther details on the underlying SDK used by the Tracker.
