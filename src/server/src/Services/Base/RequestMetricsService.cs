...
/// <summary>
/// Per-endpoint request metrics for the Tracker's API.
/// </summary>
public static class RequestMetricsService
{
...
public class RequestMetricsMiddleware
{
  ...
  public async Task InvokeAsync(HttpContext context)
  {
    ...
    if (route != null)
    {
      RequestMetricsService.Start(route);
    }
    ...
    finally
    {
      ...
      if (route != null)
      {
        RequestMetricsService.Record(route, sw.ElapsedTicks);
        RequestMetricsService.Stop(route);
      }
    }
  }
}
